    ...
    <Layout>
      ...
      <section className="relative py-12 md:py-16 overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10 text-center">
          <h1 className="font-heading text-3xl md:text-4xl font-bold text-primary mb-3 animate-fade-in">
            Arte em Estofados
          </h1>
          <div className="stitch-line max-w-[160px] mx-auto my-4" />
          <p className="text-base md:text-lg text-muted-foreground max-w-2xl mx-auto mb-6 animate-fade-in" style={{ animationDelay: "0.2s" }}>
            Atendemos grandes clientes CNPJ, artistas e produções — e também
            mobiliamos lares com o mesmo cuidado artesanal da tradição do Ipiranga.
          </p>
          <div className="flex flex-col sm:flex-row gap-3 justify-center animate-fade-in" style={{ animationDelay: "0.4s" }}>
            <Link
              to="/catalogo"
              className="inline-flex items-center gap-2 bg-accent text-accent-foreground px-5 py-2.5 rounded-md font-medium hover:opacity-90 transition-opacity"
            >
              Ver Catálogo <ArrowRight size={18} />
            </Link>
            <Link
              to="/contato"
              className="inline-flex items-center gap-2 stitch-border px-5 py-2.5 font-medium text-primary hover:bg-muted transition-colors"
            >
              Fale Conosco
            </Link>
          </div>
      ...
      <section className="py-12 md:py-16 bg-card">
        <div className="container mx-auto px-4">
          <h2 className="font-heading text-3xl font-semibold text-center text-primary mb-10">
